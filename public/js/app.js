...
var listToStyles = __webpack_require__(270)
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), __webpack_require__(16), __webpack_require__(129).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bootstrap__ = __webpack_require__(85);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Container__ = __webpack_require__(170);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__routes__ = __webpack_require__(86);
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('drawer', {
	...
	created: function created() {
		...
		__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/BroadwayJournal/personography/comprehensive/json').then(function (response) {
			_this6.personography = response.data;
			_this6.authorBibls = _this6.personography.personIndex[_this6.authorId];
		});
		Event.$on('issueBiblSelected', function (bibl) {
			_this6.showBibls = false;
			_this6.authorBibls = _this6.personography.personIndex[_this6.authorId];
		});
	},
	data: function data() {
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('intraIssueNav', {
	...
	created: function created() {
		...
		Event.$on('issueSelected', function (id) {
			_this8.issueID = id;
			_this8.tocContent = false;
			_this8.setTocContent();
		});
		Event.$on('issueBiblSelected', function (data) {
			_this8.issueID = data.issueId;
			_this8.tocContent = false;
			_this8.setTocContent();
		});
	},
	...
	methods: {
		setTocContent: function setTocContent() {
			...
			__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(url).then(function (response) {
				return _this9.tocContent = response.data;
			});
		},
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('pdf-viewer', {
	created: function created() {
		...
		Event.$on('zoomUpdate', function (level, page) {
			_this10.scale = level;
			_this10.loadPdf(_this10.current_issue, page, _this10.scale);
		}), Event.$on('nextPage', function (page) {
			_this10.current_page += 1;
			_this10.loadPdf(_this10.current_issue, _this10.current_page);
		}), Event.$on('issueSelected', function (id) {
			_this10.current_page = 1;
			_this10.current_issue = id;
			_this10.loadPdf(_this10.current_issue, _this10.current_page);
		}), Event.$on('pdf-pageChange', function (page) {
			_this10.loadPdf(_this10.current_issue, page);
		});
		Event.$on('issueBiblSelected', function (bibl) {
			_this10.current_issue = bibl.issueId;
			_this10.current_page = bibl.pdf_index;
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('tei-markup', {
	created: function created() {
		...
		Event.$on('issueSelected', function (id) {
			...
			_this11.biblId = bibl.decls_id;
			_this11.id = bibl.issueId;
			_this11.getText(_this11.biblId);
		});
		...
		getText: function getText() {
			...
			if (this.biblId) {
				...
				__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(_url).then(function (response) {
					return _this12.issueText = response.data;
				});
			} else {
				this.issueText = '';
		...
		getTocEntry: function getTocEntry(issueId, itemId) {
			...
			__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(url).then(function (response) {
				...
				for (item in bibl.toc) {
					if (item == itemId) {
						_this13.biblData = bibl.toc[item];
						return;
					}
					if (bibl.toc[item].pieces) {
						for (piece in bibl.toc[item].pieces) {
							if (piece == itemId) {
								_this13.biblData = bibl.toc[item].pieces.piece;
								return;
							}
						}
					}
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('issue-month', {
	...
	created: function created() {
		...
		Event.$on('issueSelected', function (id) {
			for (var each in _this14.$children) {
				if (_this14.$children[each].id == id) {
					_this14.$children[each].toggled = true;
				} else {
					_this14.$children[each].toggled = false;
				}
			}
		});
	},
...
new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
	...
	created: function created() {
		...
		Event.$on('aboutsSelected', function (about) {
			_this15.state.content.abouts = about;
		});
		Event.$on('viewerSelected', function (viewer) {
			return _this15.state.content.issue.viewer = viewer;
		});
		Event.$on('activeContentChange', function (content) {
			_this15.state.activeContent = content;
		});
		Event.$on('issueSelected', function (id) {
			_this15.state.content.issue.id = id;
			_this15.state.content.issue.page = 1;
			_this15.state.content.issue.decls_id = '';
			_this15.state.content.searchString = '';
		});
		Event.$on('issueBiblSelected', function (bibl) {
			_this15.state.content.issue.id = bibl.issueId;
			_this15.state.content.issue.decls_id = bibl.decls_id;
		});
		Event.$on('pdf-pageChange', function (page) {
			_this15.state.content.issue.page = page;
		});
		Event.$on('searchSubmitted', function (searchString) {
			_this15.state.content.searchString = searchString;
		});
		// get abouts data
		__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/broadwayjournal/abouts/credits').then(function (response) {
			return _this15.xhrDataStore.abouts.credits = response.data;
		});
		__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/broadwayjournal/abouts/about').then(function (response) {
			return _this15.xhrDataStore.abouts.about = response.data;
		});
		__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/broadwayjournal/abouts/tech').then(function (response) {
			return _this15.xhrDataStore.abouts.tech = response.data;
		});
		__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/broadwayjournal/abouts/personography').then(function (response) {
			return _this15.xhrDataStore.abouts.personographyDescription = response.data;
		});

		__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/BroadwayJournal/personography/comprehensive/json').then(function (response) {
			_this15.xhrDataStore.personography = response.data;
			Event.$emit('personographyLoaded', _this15.xhrDataStore.personography);
		});

		__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/all-issues/json').then(function (response) {
			_this15.journals = response.data;

			for (var issue in _this15.journals) {
				var id = _this15.journals[issue];
				var iid = Util.datePartsForIssueId(id);
				_this15.journals[issue] = {
					'id': id,
					'year': iid.year,
					'month': iid.month,
					'day': iid.day
				};
				if (_this15.years.indexOf(iid.year) == -1) {
					_this15.years.push(iid.year);
				}
			}
		});
	}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vueHeader__ = __webpack_require__(177);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vueContent__ = __webpack_require__(175);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vueFooter__ = __webpack_require__(176);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__issueHeader__ = __webpack_require__(173);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__issueHeader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__issueHeader__);


/* harmony default export */ __webpack_exports__["default"] = ({
    components: { issueHeader: __WEBPACK_IMPORTED_MODULE_0__issueHeader___default.a }
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__personIndex__ = __webpack_require__(174);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        Event.$on('issueSelected', function (id) {
            var headerUrl = '/api/broadwayjournal/issue/' + _this.$root.state.content.issue.id + '/header';
            axios.get(headerUrl).then(function (response) {
                return _this.issueHeaderData = response.data;
            });
            _this.biblId = '';
        });
        Event.$on('issueBiblSelected', function (bibl) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_loading_spinner__ = __webpack_require__(228);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Abouts__ = __webpack_require__(13);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__headerNav__ = __webpack_require__(172);
...
Component.options.__file = "/var/www/dsl-print-culture/resources/assets/js/components/issueHeader.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] issueHeader.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4761c3b0", Component.options)
  } else {
    hotAPI.reload("data-v-4761c3b0", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), (this.showBiblSectionMeta()) ? _c('biblSectionMeta', {
    attrs: {
      "sectionMeta": this.issueHeaderData.listBibl[this.biblId].sectionMeta
    }
  }) : _vm._e()], 1), _vm._v(" "), (_vm.haveData()) ? _c('div', {
    staticClass: "bibl"
  }, [_c('div', {
    staticClass: "issue"
  }, [_c('a', {
  ...
  }, [_vm._v("View " + _vm._s(this.dlLabel()))])]), _vm._v(" "), (!this.$root.empty(this.issueHeaderData.listBibl[this.biblId].pieceMeta) && !_vm.pdfMode()) ? _c('biblPieceMeta', {
    attrs: {
      "pieceMeta": this.issueHeaderData.listBibl[this.biblId].pieceMeta
    }
  }) : _vm._e()], 1), _vm._v(" "), (this.getPersonMeta()) ? _c('personMeta', {
    attrs: {
      "personMeta": this.getPersonMeta()
    }
  }) : _vm._e(), _vm._v(" "), (this.drawerIsAvailable()) ? _c('button', {
    attrs: {
      "id": "show-modal"
    },
    on: {
  ...
  }, [_vm._v("More from this author")]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "issueData"
  }), _vm._v(" "), _c('div', {
    staticClass: "authorShipLegend"
  }, [_vm._v(_vm._s(this.authorShipLegend))])], 1) : _vm._e(), _vm._v(" "), (this.showModal) ? _c('modal', {
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4761c3b0", module.exports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Circle_vue__ = __webpack_require__(130);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Circle2_vue__ = __webpack_require__(133);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Circle3_vue__ = __webpack_require__(134);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Circle4_vue__ = __webpack_require__(135);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Circle5_vue__ = __webpack_require__(136);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Circle6_vue__ = __webpack_require__(137);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Circle7_vue__ = __webpack_require__(138);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Circle8_vue__ = __webpack_require__(139);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Circle9_vue__ = __webpack_require__(140);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Circle10_vue__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_Circle11_vue__ = __webpack_require__(132);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_CubeShadow_vue__ = __webpack_require__(141);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_Diamond_vue__ = __webpack_require__(142);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_DoubleBounce_vue__ = __webpack_require__(143);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_Gauge_vue__ = __webpack_require__(144);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_Google_vue__ = __webpack_require__(145);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_Hexagon_vue__ = __webpack_require__(146);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_HourGlass_vue__ = __webpack_require__(147);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_Jawn_vue__ = __webpack_require__(148);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_Jumper_vue__ = __webpack_require__(149);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_LetterCube_vue__ = __webpack_require__(150);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__components_Mikepad_vue__ = __webpack_require__(151);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__components_Origami_vue__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__components_Pencil_vue__ = __webpack_require__(153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__components_PingPong_vue__ = __webpack_require__(154);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__components_Plane_vue__ = __webpack_require__(155);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__components_RotateSquare_vue__ = __webpack_require__(156);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__components_RotateSquare2_vue__ = __webpack_require__(157);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__components_RotateSquare3_vue__ = __webpack_require__(158);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__components_RotateSquare4_vue__ = __webpack_require__(159);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__components_RotateSquare5_vue__ = __webpack_require__(160);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__components_ScaleOut_vue__ = __webpack_require__(161);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__components_Socket_vue__ = __webpack_require__(162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__components_SpinLine_vue__ = __webpack_require__(163);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__components_SquareGrid_vue__ = __webpack_require__(164);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__components_Stretch_vue__ = __webpack_require__(165);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__components_Texture_vue__ = __webpack_require__(166);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__components_ThreeDots_vue__ = __webpack_require__(167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__components_TwoCube_vue__ = __webpack_require__(168);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__components_Wave_vue__ = __webpack_require__(169);
